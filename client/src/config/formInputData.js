export const textureMapOptions = [
    { value: "albedo", label: "Albedo", color: "purple" },
    { value: "diffuse", label: "Diffuse", color: "red" },
    { value: "ao", label: "Ambient Occlusion", color: "yellow" },
    { value: "specular", label: "Specular", color: "orange" },
    { value: "metalness", label: "Metalness", color: "green" },
