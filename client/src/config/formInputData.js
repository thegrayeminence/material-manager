...
export const colorOptions = [...new Set(colorOptionsUnfiltered)];
 ...
 const elementTypeOptionsUnfiltered = [
  ...
  "Plastic", "Acrylic", "Nylon", "Polyester", "Rubber", "Silicone",
...
const manifestationOptionsUnfiltered = [
  ...
  "Sink", "Towel", "Soap", "Toaster", "Blender", "Mixer", "Juicer", "Teapot", "Kettle", "Grill", "Book", "Notebook", "Pen",
  ...
  "Ship", "Plane", "Helicopter", "Train", "Bus", "Truck", "Scooter", "Skateboard", "Skates",
  ...
  "Plateau", "Cave","Garden", "Orchard", "Vineyard", "Farm", "Ranch", "Terrace", "Porch", "Balcony", "Patio", "Deck",
  "Stairs", "Ladder", "Ramp", "Bridge", "Railing", "Fence", "Gate", "Path", "Road", "Street",
  ...
  "Vegetable", "Herb", "Spice", "Meat", "Fish", "Wheel", "Bread", "Cake", "Gas", "Cloud", "Puddle", "Plasma", "Neon", "Carbon",
  "Mirror", "Cover", "Sheet", "Blanket", "Towel", "Rug", "Carpet", "Curtain", "Drape", "Flag",
  "Painting", "Picture", "Poster", "Frame", "Sculpture", "Statue",
  "Rock", "Rubble", "Brick", "Tile", "Sand", "Dirt", "Mud", "Clay", "Gravel", "Pebble",
  "Wood", "Log", "Stick", "Twig", "Branch", "Leaf", "Bark", "Root", "Trunk", "Paper",
  "Cardboard", "Cork", "Foam", "Graphite", "Wax", "Gelatin", "Resin", "Plaster", "Fiberglass", "Kevlar", "Orb",
  "Cube","Sphere", "Cylinder", "Cone", "Pyramid","Prism", "Helix", "Knot", "Strip", "Bottle",
  "Can", "Box", "Container", "Basket", "Bin", "Bucket", "Vase", "Bowl", "Plate", "Cup",
  "Jar", "Jug", "Pitcher", "Door", "Window", "Wall", "Floor", "Ceiling", "Roof", "Fence",
]
