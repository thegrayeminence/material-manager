...
export default function StylishButton({handleClick, text, ...props}) {
    ...
    return (
        <GradientButton
            ...
            bgGradient={useColorModeValue("linear(to-r, teal.400, green.400)", 'linear(to-l, #7928CA, #FF0080)')}
            color="white"
            borderRadius={'md'}
            _hover={{bgGradient: useColorModeValue('linear(to-l, #7928CA, #FF0080)', "linear(to-r, teal.400, green.400)")}}
