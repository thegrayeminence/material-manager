...
export default function PBROnePreviewBox_NotGallery({images, types, roughness}) {

    const color_map_url = images[types[0]];
    const height_map_url = images[types[1]];
    const normal_map_url = images[types[2]];
    const smoothness_map_url = images[types[3]];
    ...
    const pbrOneSrc = `${baseUrl}${query_params}`
    console.log("source", pbrOneSrc)
