...
#     folder_path = os.path.join(app.static_folder, 'assets', 'images', secure_filename(folder_name))
#     print("path",folder_path)
#     zip_filename = folder_name + '.zip'
#     temp_zip_path = os.path.join(app.root_path, 'temp', zip_filename)
...
#     #         print(f"Cleaned up temp file: {temp_zip_path}")
#     #     except Exception as e:
#     #             make_response(f"Failed to clean up temp file {temp_zip_path}: {e}")
#     #     return response

#     return send_from_directory(directory=os.path.dirname(temp_zip_path), filename=zip_filename, as_attachment=True)
